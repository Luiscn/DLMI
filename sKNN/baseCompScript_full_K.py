...
for ii in range(len(pat_ids_test)):
    ...
    runfile('/Volumes/My Passport/baseComp_full_K.py', wdir='/Volumes/My Passport')
    distComp[0,ii] = sDist(true_mag, nn_mag_mean)
...
#bins_list = [0, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000]
...
runfile('/Volumes/My Passport/kernelDE.py', wdir='/Volumes/My Passport')
